document.addEventListener('DOMContentLoaded', function () {
    ...
    if (!listWrapper) {
        console.warn('Date-sorting script: listWrapper not found');
        return;
    }
    ...
    function getCurrentOrder() {
        const sel = document.querySelector('input[name="date-sort"]:checked');
        if (!sel) {
            return 'desc';
        }
    ...
    const radioInputs = document.querySelectorAll('input[name="date-sort"]');
    radioInputs.forEach(radio => {
        radio.addEventListener('change', () => {
            document.querySelectorAll('label.w-radio').forEach(lbl => {
    ...
    const defaultLatestRadio = document.getElementById('Latest');
    if (defaultLatestRadio) {
        if (!document.querySelector('input[name="date-sort"]:checked')) {
